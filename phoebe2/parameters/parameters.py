...
from phoebe2.constraints.expression import ConstraintVar
from phoebe2.parameters.twighelpers import _uniqueid_to_uniquetwig
from phoebe2.parameters.twighelpers import _twig_to_uniqueid
from phoebe2.frontend import tabcomplete, plotting, mpl_animate
...
class ParameterSet(object):
    ...
    def get_or_create(self, qualifier, new_parameter, **kwargs):
        ...
        :class:`phoebe2.frontend.bundle.Bundle`,
    ...
    def remove_parameter(self, twig=None, **kwargs):
        ...
        (including the :class:`phoebe2.frontend.bundle.Bundle`)
    ...
    def set_value(self, twig=None, value=None, **kwargs):
        ...
        the :class:`phoebe2.frontend.bundle.Bundle`)
    ...
    def plot(self, *args, **kwargs):
        ...
        :parameter str backend: Plotting backend to use.  Will default to
            'plotting_backend' from the :class:`phoebe2.frontend.bundle.Bundle`
        ...
        :parameter str x: qualifier or twig of the array to plot on the x-axis (will
            ...
            the ephemeris from :meth:`phoebe2.frontend.bundle.Bundle.get_ephemeris` if possible.
    ...
    def show(self, **kwargs):
        ...
        :parameter str backend: which plotting backend to use.  Will default to
                ...
                :class:`phoebe2.frontend.bundle.Bundle` if not provided.
        """
...
class Parameter(object):
    def __init__(self, qualifier, value=None, description='', **kwargs):
        ...
        :parameter bundle: (optional) parent :class:`phoebe2.frontend.bundle.Bundle`
    ...
    def uniquetwig(self, ps=None):
        ...
        :parameter ps: :class:`ParameterSet` in which the returned
            ...
            or None this will default to the parent :class:`phoebe2.frontend.bundle.Bundle`,
            if available.
        :return: uniquetwig
        :rtype: str
        """
    ...
    def get_parent_ps(self):
        ...
        :class:`phoebe2.frontend.bundle.Bundle` which share the same
...
class FloatParameter(Parameter):
    ...
    def set_quantity(self, value, unit=None, force=False, run_checks=True, **kwargs):
        ...
        if isinstance(unit, str):
            ...
            raise TypeError("unit must be an phoebe2.u.Unit or None, got {}".format(unit))
...
class FloatArrayParameter(FloatParameter):
    ...
    def interp_value(self, **kwargs):
        ...
        :meth:`phoebe2.frontend.bundle.Bundle.to_time` to convert to a valid
    ...
    def get_result(self, t=None):
        ...
        if _use_sympy and not eq_needs_builtin(eq):
            ...
            if eq_needs_builtin(eq):
                ...
                from phoebe2.constraints.builtin import ecosw2per0, esinw2per0, potential2rpole, rpole2potential
