...
from phoebe2.parameters import hierarchy as _hierarchy
from phoebe2.parameters import system as _system
from phoebe2.parameters import setting as _setting
from phoebe2.parameters import dataset as _dataset
from phoebe2.parameters import compute as _compute
from phoebe2.parameters import constraint as _constraint
from phoebe2.backend import backends
from phoebe2.frontend import io
from phoebe2.distortions.roche import critical_potential
...
class Bundle(ParameterSet):
    ...
    :class:`phoebe2.parameters.parameters.ParameterSet`. In fact, filtering on
    ...
    :class:`phoebe2.parameters.parameters.ParameterSet` *
    :class:`phoebe2.parameters.parameters.Parameter` *
    :class:`phoebe2.parameters.parameters.FloatParameter` *
    :class:`phoebe2.parameters.parameters.ArrayParameter`
    ...
    To filter parameters and set values, see:
        * :meth:`phoebe2.parameters.parameters.ParameterSet.filter`
        * :meth:`phoebe2.parameters.parameters.ParameterSet.get_value`
        * :meth:`phoebe2.parameters.parameters.ParameterSet.set_value`
    ...
    To plot observations or synthetic datasets, see:
        * :meth:`phoebe2.parameters.parameters.ParameterSet.plot`
    ...
    def __init__(self, params=None):
        ...
        :param list parameters: list of
            :class:`phoebe2.parameters.parameters.Parameter` to create the
            Bundle (optional)
    ...
    def get_setting(self, twig=None, **kwargs):
        ...
        :parameter **kwargs: any other tags to do the filter (except tag or
            context)
        :return: :class:`phoebe2.parameters.parameters.ParameterSet`
        """
        if twig is not None:
            kwargs['twig'] = twig
    ...
    def get_history(self, i=None):
        ...
        :return: :class:`phoebe2.parameters.parameters.Parameter` if i is
            an int, or :class:`phoebe2.parameters.parameters.ParameterSet` if i
            is not provided
    ...
    def get_system(self, twig=None, **kwargs):
        ...
        :return: :class:`phoebe2.parameters.parameters.Parameter` or
            :class:`phoebe2.parameters.parameters.ParameterSet`
        """
        if twig is not None:
            kwargs['twig'] = twig
    ...
    def hierarchy(self):
        ...
        :return: the hierarcy :class:`phoebe2.parameters.parameters.Parameter`
    ...
    def add_component(self, method, **kwargs):
        ...
        Available methods include:
            * :func:`phoebe2.parameters.component.star`
            * :func:`phoebe2.parameters.component.orbit`
        ...
        :parameter method: function to call that returns a
            ...
            be found in the :mod:`phoebe2.parameters.component` module
            (ie. 'star', 'orbit')
        ...
        :parameter **kwargs: default values for any of the newly-created
            parameters
        :return: :class:`phoebe2.parameters.parameters.ParameterSet` of
    ...
    def add_dataset(self, method, component=None, **kwargs):
        ...
        Available methods include:
            * :func:`phoebe2.parameters.dataset.lc`
            * :func:`phoebe2.parameters.dataset.rv`
            * :func:`phoebe2.parameters.dataset.etv`
            * :func:`phoebe2.parameters.dataset.orb`
            * :func:`phoebe2.parameters.dataset.mesh`

        :parameter method: function to call that returns a
            ParameterSet or list of parameters.  This must either be
            a callable function that accepts nothing but default
            values, or the name of a function (as a string) that can
            be found in the :mod:`phoebe2.parameters.dataset` module
        :type method: str or callable
    ...
    def flip_constraint(self, twig=None, solve_for=None, **kwargs):
        ...
        :type solve_for: str or :class:`phoebe2.parameters.parameters.Parameter
        :parameter **kwargs: any other tags to do the filter
            (except twig or context)
    ...
    def add_compute(self, method=compute.phoebe, **kwargs):
        ...
        Available methods include:
            * :func:`phoebe2.parameters.compute.phoebe`
            * :func:`phoebe2.parameters.compute.legacy`
            * :func:`phoebe2.parameters.compute.photodynam`
            * :func:`phoebe2.parameters.compute.jktebop`

        :parameter method: function to call that returns a
            ParameterSet or list of parameters.  This must either be
            a callable function that accepts nothing but default
            values, or the name of a function (as a string) that can
            be found in the :mod:`phoebe2.parameters.compute` module
        :type method: str or callable
    ...
    def run_compute(self, compute=None, model=None, detach=False,
        ...
        :parameter bool datach: [EXPERIMENTAL] whether to detach from the computation run,
            ...
            :meth:`get_model` and :meth:`phoebe2.parameters.parameters.JobParameter`
            ...
            :meth:`phoebe2.parameters.parameters.JobParameter` will then contain
        ...
        :return: :class:`phoebe2.parameters.parameters.ParameterSet` of the
        ...
        if detach:
            ...
            f.write("import phoebe2; import json\n")
            ...
            f.write("b = phoebe2.Bundle(bdict)\n")
