...
#        if isinstance(eb.get_parameter(prpars[x], component='primary'), phoebe2.parameters.FloatParameter):
...
#                if isinstance(eb.get_parameter(prpars[0], component='primary'), phoebe2.parameters.Float                elif 'ld_' in param.qualifier:
#                    param = None
#Parameter):
