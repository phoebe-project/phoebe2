...
PHOEBE_curve *phoebe_curve_new_from_pars (PHOEBE_curve_type ctype, int index)
{
	...
	if (ctype == PHOEBE_CURVE_LC) {
		/***********************/
		/* 1. phoebe_lc_indep: */
		phoebe_get_parameter_value ("phoebe_lc_indep", index, &param);
		...
		/*********************/
		/* 2. phoebe_lc_dep: */
		phoebe_get_parameter_value ("phoebe_lc_dep", index, &param);
		...
		phoebe_get_parameter_value ("phoebe_lc_indweight", index, &param);
		...
		phoebe_get_parameter_value ("phoebe_lc_filename", index, &filename);

		/************************/
		/* 5. phoebe_lc_filter: */
		phoebe_get_parameter_value ("phoebe_lc_filter", index, &param);
		...
		/***********************/
		/* 6. phoebe_lc_sigma: */
		phoebe_get_parameter_value ("phoebe_lc_sigma", index, &sigma);
	}

	if (ctype == PHOEBE_CURVE_RV) {
		/***********************/
		/* 1. phoebe_lc_indep: */
		phoebe_get_parameter_value ("phoebe_rv_indep", index, &param);
		status = phoebe_column_type_from_string (param, &itype);
		if (status != SUCCESS)
			return NULL;
		...
		/*********************/
		/* 2. phoebe_lc_dep: */
		phoebe_get_parameter_value ("phoebe_rv_dep", index, &param);
		status = phoebe_column_type_from_string (param, &dtype);
		if (status != SUCCESS)
			return NULL;
		...
		/***************************/
		/* 3. phoebe_lc_indweight: */
		phoebe_get_parameter_value ("phoebe_rv_indweight", index, &param);
		status = phoebe_column_type_from_string (param, &wtype);
		if (status != SUCCESS)
			return NULL;
		...
		/**************************/
		/* 4. phoebe_lc_filename: */
		phoebe_get_parameter_value ("phoebe_rv_filename", index, &filename);

		/************************/
		/* 5. phoebe_lc_filter: */
		phoebe_get_parameter_value ("phoebe_rv_filter", index, &param);
		passband = phoebe_passband_lookup (param);
		if (!passband)
			return NULL;
		...
		/***********************/
		/* 6. phoebe_lc_sigma: */
		phoebe_get_parameter_value ("phoebe_rv_sigma", index, &sigma);
	}
...
char *phoebe_input_dep_name (PHOEBE_input_dep   dep)
{
	switch (dep) {
		case INPUT_FLUX:
			return "flux";
		case INPUT_MAGNITUDE:
			return "magnitude";
		case INPUT_PRIMARY_RV:
			return "primary RV";
		case INPUT_SECONDARY_RV:
			return "secondary RV";
		default:
			return "invalid";
	}
...
{
	switch (weight) {
		case INPUT_STANDARD_DEVIATION:
			return "standard deviation";
		case INPUT_STANDARD_WEIGHT:
...
char *phoebe_output_dep_name (PHOEBE_output_dep dep)
{
	switch (dep) {
		...
		case OUTPUT_SECONDARY_FLUX:
			return "secondary flux";
		case OUTPUT_PRIMARY_RV:
			return "primary RV";
		case OUTPUT_SECONDARY_RV:
			return "secondary RV";
		case OUTPUT_PRIMARY_NORMALIZED_RV:
			return "primary normalized RV";
		case OUTPUT_SECONDARY_NORMALIZED_RV:
			return "secondary normalized RV";
		case OUTPUT_BOTH_RVS:
			return "both RVs";
		default:
			return "invalid";
	}
...
char *phoebe_output_weight_name (PHOEBE_output_weight weight)
{
	switch (weight) {
		case OUTPUT_STANDARD_DEVIATION:
			return "standard deviation";
		case OUTPUT_STANDARD_WEIGHT:
			return "standard weight";
...
int phoebe_lc_params_update (WD_LCI_parameters params, int curve)
	{
	phoebe_set_parameter_value ("phoebe_hjd0",    params.HJD0);
	phoebe_set_parameter_value ("phoebe_period",  params.PERIOD);
	phoebe_set_parameter_value ("phoebe_dpdt",    params.DPDT);
	phoebe_set_parameter_value ("phoebe_pshift",  params.PSHIFT);
	phoebe_set_parameter_value ("phoebe_ecc",     params.E);
	phoebe_set_parameter_value ("phoebe_sma",     params.SMA);
	phoebe_set_parameter_value ("phoebe_f1",      params.F1);
	phoebe_set_parameter_value ("phoebe_f2",      params.F2);
	phoebe_set_parameter_value ("phoebe_vga",     params.VGA);
	phoebe_set_parameter_value ("phoebe_incl",    params.INCL);
	phoebe_set_parameter_value ("phoebe_grb1",    params.GR1);
	phoebe_set_parameter_value ("phoebe_grb2",    params.GR2);
	phoebe_set_parameter_value ("phoebe_teff1",   params.TAVH);
	phoebe_set_parameter_value ("phoebe_teff2",   params.TAVC);
	phoebe_set_parameter_value ("phoebe_alb1",    params.ALB1);
	phoebe_set_parameter_value ("phoebe_alb2",    params.ALB2);
	phoebe_set_parameter_value ("phoebe_pot1",    params.PHSV);
	phoebe_set_parameter_value ("phoebe_pot2",    params.PCSV);
	phoebe_set_parameter_value ("phoebe_rm",      params.RM);
	phoebe_set_parameter_value ("phoebe_hla",     curve, params.HLA);
	phoebe_set_parameter_value ("phoebe_cla",     curve, params.CLA);
	phoebe_set_parameter_value ("phoebe_ld_lcx1", curve, params.X1A);
	phoebe_set_parameter_value ("phoebe_ld_lcx2", curve, params.X2A);
	phoebe_set_parameter_value ("phoebe_ld_lcy1", curve, params.Y1A);
	phoebe_set_parameter_value ("phoebe_ld_lcy2", curve, params.Y2A);
	}
...
int phoebe_rv_params_update (WD_LCI_parameters params, int curve)
	...
	phoebe_set_parameter_value ("phoebe_pot2",    params.PCSV);
	phoebe_set_parameter_value ("phoebe_rm",      params.RM);
	phoebe_set_parameter_value ("phoebe_ld_rvx1", curve, params.X1A);
	phoebe_set_parameter_value ("phoebe_ld_rvx2", curve, params.X2A);
	phoebe_set_parameter_value ("phoebe_ld_rvy1", curve, params.Y1A);
	phoebe_set_parameter_value ("phoebe_ld_rvy2", curve, params.Y2A);
	}
