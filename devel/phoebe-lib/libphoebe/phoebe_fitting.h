...
#define wd_dc(atmtab,pltab,l3perc,knobs,indeps,fluxes,weights,corrs,errors,chi2s,cormat,params,cfval) dc_(atmtab,pltab,l3perc,knobs,indeps,fluxes,weights,corrs,errors,chi2s,cormat,params,cfval,strlen(atmtab),strlen(pltab))
