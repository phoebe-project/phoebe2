...
import os
from phoebe2.utils import coordinates, fgeometry
from phoebe2.algorithms import cmarching
from phoebe2.atmospheres import limbdark, passbands
from phoebe2.dynamics import ctrans
from phoebe2.distortions import roche
from phoebe2.backend import eclipse, subdivision
import copy
...
class System(object):
    ...
    def from_bundle(cls, b, compute=None, datasets=[], **kwargs):
        """
        Build a system from the :class:`phoebe2.frontend.bundle.Bundle` and its
        hierarchy.
...
class Star(Body):
    ...
    def from_bundle(cls, b, component, compute=None, dynamics_method='keplerian', datasets=[], **kwargs):
        """
        Build a star from the :class:`phoebe2.frontend.bundle.Bundle` and its
        hierarchy.
...
class Envelope(Body):
    ...
    def from_bundle(cls, b, component, compute=None, dynamics_method='keplerian', datasets=[], **kwargs):
        ...
        Build an overcontact from the :class:`phoebe2.frontend.bundle.Bundle` and its
        hierarchy.
