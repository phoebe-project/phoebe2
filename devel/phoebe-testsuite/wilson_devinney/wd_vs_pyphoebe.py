...
phoebe.observe(bbag,times,subdiv_num=2,lc=True,rv=True,eclipse_alg='convex')
c3 = time.time()
...
+-----------------------------------+---------------------------------+
| .. image:: 01_lc_comparison.png   | .. image:: 01_rv_comparison.png |
...
"""
.. figure:: 01_image_comparison.png
   :scale: 75 %
   :align: center
