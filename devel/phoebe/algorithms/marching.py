...
def dHeartdx(r):
    return (3*(r[0]**2 + 9./4.*r[1]**2 + r[2]**2 - 1)**3*2*r[0] - 2*r[0]*r[2]**3)

def dHeartdy(r):
    return (3*(r[0]**2 + 9./4.*r[1]**2 + r[2]**2 - 1)**3*9./2.*r[1]                 -  9./40.*r[1]*r[2]**3)

def dHeartdz(r):
    return (3*(r[0]**2 + 9./4.*r[1]**2 + r[2]**2 - 1)**3*2*r[2] - 3*r[0]**2*r[2]**2 - 27./80.*r[1]**2*r[2]**2)
