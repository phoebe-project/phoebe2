...
defs += [dict(qualifier='ld_func', description='Limb darkening model',repr='%s',cast_type='choose',choices=['uniform','linear','logarithmic', 'quadratic', 'square_root','power', 'claret', 'hillen', 'prsa'],value='uniform',frame=["phoebe"],context=['lcdep','amdep','rvdep']),
         ...
         dict(qualifier='ref',      description='Name of the observable',repr='%s',cast_type=str,value='',frame=["phoebe"],hidden=True,context=['lcdep','amdep','rvdep','ifdep','spdep','pldep','etvdep','sidep','orbdep']),
         ...
         dict(qualifier='filename', description='Name of the file containing the data',repr='%s',cast_type=str,value='',frame=['phoebe'],context=['lcobs','spobs','rvobs','ifobs','plobs','etvobs','amobs','siobs','orbobs','lcsyn','ifsyn','rvsyn','spsyn','ifobs','ifsyn','plsyn','etvsyn','amsyn','sisyn','orbsyn']),
         dict(qualifier='ref',    description='Name of the data structure',repr='%s',cast_type=str,value='',hidden=False,frame=["phoebe"],context=['lcobs','rvobs','spobs','ifobs','etvobs','orbobs','psdep','lcsyn','spsyn','amsyn','rvsyn','ifsyn','plsyn','plobs','etvsyn','amobs','lttsyn','orbsyn']),
         #dict(qualifier='scale',    description='Linear scaling constant',repr='%f',cast_type=float,value=1.0,frame=["phoebe"],context=['lcsyn','spsyn','amsyn','rvsyn','ifsyn','plsyn','etvsyn','lttsyn']),
         #dict(qualifier='offset',    description='Offset constant',repr='%f',cast_type=float,value=0.0,frame=["phoebe"],context=['lcsyn','spsyn','amsyn','rvsyn','ifsyn','plsyn','etvsyn','lttsyn']),
         dict(qualifier='time',     description='Timepoints of the data',repr='%s',cast_type=np.array,value=[],unit='JD',frame=['phoebe'],context=['lcobs','spobs','rvobs','ifobs','plobs','etvobs','amobs','siobs','orbobs','orbsyn']),
         dict(qualifier='phase',     description='Phasepoints of the data',repr='%s',cast_type=np.array,value=[],unit='cy',frame=['phoebe'],context=['lcobs','spobs','rvobs','ifobs','plobs','etvobs','orbobs','orbsyn']),
         ...
         dict(qualifier='columns',  description='Data columns',repr='%s',value=['time','x','y','z','vx','vy','vz'],frame=["phoebe"],context=['orbobs','orbsyn']),
         ...
         dict(qualifier='user_columns', description='Column names given by user', repr='%s', write_protected=True,value=None, hidden=True, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs','ifobs','spobs','plobs','etvobs','orbobs']),
         dict(qualifier='user_components', description='Component names given by user', repr='%s', write_protected=True,value=None, hidden=True, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs','spobs','plobs','etvobs','orbobs']),
         dict(qualifier='user_dtypes', description='Data types given by user', repr='%s', write_protected=True,value=None, hidden=True, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs','spobs','plobs','etvobs','orbobs']),
         dict(qualifier='user_units', description='Units given by user', repr='%s', write_protected=True, value=None, hidden=True, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs','spobs','plobs','etvobs','orbobs']),
        ]

# lttsyn context
defs += [dict(qualifier='bary_time', description='Barycentric times', repr='%s', value=[], context='lttsyn', frame='phoebe'),
         dict(qualifier='prop_time', description='Proper times', repr='%s', value=[], context='lttsyn', frame='phoebe'),
         dict(qualifier='position', description='Position of the object in the orbit', repr='%s', value=[], context='lttsyn', frame='phoebe'),
         dict(qualifier='velocity', description='Velocity of the object in the orbit', repr='%s', value=[], context='lttsyn', frame='phoebe'),
         dict(qualifier='columns',  description='Data columns',repr='%s',value=['bary_time', 'prop_time'],cast_type='return_list_of_strings',frame=["phoebe"],context=['lttsyn']),
        ]
        
# orbsyn context
defs += [dict(qualifier='x', description='x position of the object in the orbit (RSol)', repr='%s', value=[], context=['orbobs', 'orbsyn'], frame='phoebe'),
         dict(qualifier='y', description='y position of the object in the orbit (RSol)', repr='%s', value=[], context=['orbobs', 'orbsyn'], frame='phoebe'),
         dict(qualifier='z', description='z position of the object in the orbit (RSol)', repr='%s', value=[], context=['orbobs', 'orbsyn'], frame='phoebe'),
         dict(qualifier='vx', description='x velocity of the object in the orbit (RSol/d)', repr='%s', value=[], context=['orbobs', 'orbsyn'], frame='phoebe'),
         dict(qualifier='vy', description='x velocity of the object in the orbit (RSol/d)', repr='%s', value=[], context=['orbobs', 'orbsyn'], frame='phoebe'),
         dict(qualifier='vz', description='x velocity of the object in the orbit (RSol/d)', repr='%s', value=[], context=['orbobs', 'orbsyn'], frame='phoebe'),
        ]
