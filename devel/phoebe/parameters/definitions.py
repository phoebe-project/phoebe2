...
defs += [dict(qualifier='ld_func', description='Limb darkening model',repr='%s',cast_type='choose',choices=['uniform','linear','logarithmic', 'quadratic', 'square_root','power', 'claret', 'hillen', 'prsa'],value='uniform',frame=["phoebe"],context=['lcdep','amdep','rvdep']),
         ...
         dict(qualifier='label',    description='Name of the observable',repr='%s',cast_type='make_label',value='',hidden=True,frame=["phoebe"],context=['puls','circ_orbit']),
         ...
         dict(qualifier='time', description='Timepoint ETV',repr='%s',value=[],frame=["phoebe"],context='etvsyn'),
...
defs += [dict(qualifier='ld_func',   description='Limb darkening model',repr='%s',cast_type=str,value='uniform',frame=["phoebe"],context='ifdep'),
         ...
         dict(qualifier='ucoord',   description='U-coord',repr='%s',value=[],unit='m',frame=["phoebe"],context=['ifobs','ifsyn']),
         dict(qualifier='vcoord',   description='V-coords',repr='%s',value=[],unit='m',frame=["phoebe"],context=['ifobs','ifsyn']),
         dict(qualifier='eff_wave',   description='Effective wavelength',repr='%s',value=[],unit='nm',frame=["phoebe"],context=['ifobs','ifsyn']),
...
defs += [dict(qualifier='ref',        description='identifier for the axes options',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:axes'),
         ...
         dict(qualifier='phased',       description="whether to show the x-axis phased (x_unit will override this)", repr='', cast_type='make_bool', value=False,frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='title',        description="title of the plot", repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='x_unit',        description="unit to plot on the xaxis", repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='y_unit',        description="unit to plot on the yaxis", repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:axes'),
         ...
         dict(qualifier='xlim',        description="limits on the xaxis", repr='%s',cast_type=tuple,value=(None,None),frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='ylim',        description="limits on the yaxis", repr='%s',cast_type=tuple,value=(None,None),frame=["phoebe"],context='plotting:axes'),
...
defs += [dict(qualifier='ref',        description='identifier for the plotting options',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         dict(qualifier='datatwig',          description='twig to the dataset',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='active',          description='whether to draw this plot on the axes',repr='',cast_type='make_bool',value=True,frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         dict(qualifier='repeat',       description='handy if you are actually fitting a phase curve, and you want to repeat the phase curve a couple of times.',repr='',cast_type='make_bool',value=False,frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         dict(qualifier='fmt',          description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         dict(qualifier='color',        description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         dict(qualifier='alpha',        description='see matplotlib.axes.Axes.plot',repr='%f',cast_type=float,value=1.0,frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         dict(qualifier='marker',       description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='markersize',   description='see matplotlib.axes.Axes.plot',repr='%d',cast_type=int,value=5,frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='markeredgecolor',   description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='markerfacecolor',   description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='linestyle',    description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='linewidth',    description='see matplotlib.axes.Axes.plot',repr='%d',cast_type=int,value=1,frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='zorder',    description='see matplotlib.axes.Axes.plot',repr='%d',cast_type=int,value=1,frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
        ]
        
defs += [dict(qualifier='ref',        description='identifier for the plotting options',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_syn'),
         dict(qualifier='datatwig',          description='twig to the dataset',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='active',          description='whether to draw this plot on the axes',repr='',cast_type='make_bool',value=True,frame=["phoebe"],context='plotting:plot_syn'),
         dict(qualifier='repeat',       description='handy if you are actually fitting a phase curve, and you want to repeat the phase curve a couple of times.',repr='',cast_type='make_bool',value=False,frame=["phoebe"],context='plotting:plot_syn'),
         dict(qualifier='fmt',          description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:plot_syn'),
         dict(qualifier='color',        description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:plot_syn'),
         dict(qualifier='alpha',        description='see matplotlib.axes.Axes.plot',repr='%f',cast_type=float,value=1.0,frame=["phoebe"],context='plotting:plot_syn'),
         dict(qualifier='marker',       description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='markersize',   description='see matplotlib.axes.Axes.plot',repr='%d',cast_type=int,value=5,frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='markeredgecolor',   description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='markerfacecolor',   description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='linestyle',    description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='_auto_',frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='linewidth',    description='see matplotlib.axes.Axes.plot',repr='%d',cast_type=int,value=1,frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='zorder',    description='see matplotlib.axes.Axes.plot',repr='%d',cast_type=int,value=1,frame=["phoebe"],context='plotting:plot_syn'),
        ]
        
defs += [dict(qualifier='ref',        description='identifier for the plotting options',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_mesh'),
         ...
         dict(qualifier='dpi',         description='',repr='%d',cast_type=int,value=80,frame=["phoebe"],context='plotting:plot_mesh'),
         dict(qualifier='select', description='what quantity is mapped to color',repr='%s',cast_type='choose',choices=['proj','teff','logg','rv','mu','B','Bx','By','Bz'],value='proj',frame=["phoebe"],context='plotting:plot_mesh'),
...
#~ defs += [dict(qualifier='type', description='type of selector',repr='',cast_type='choose',choices=['axvline','axvspan','interp'],value='axvline',frame=["phoebe"],context='plotting:selector'),
         #~ dict(qualifier='marker', description='marker if type==interp, see matplotlib.axes.Axes.plot',repr='',cast_type=str,value='s',frame=["phoebe"],context='plotting:selector'),
         #~ dict(qualifier='color', description='color of selector, see matplotlib color options',repr='%s',cast_type=str,value='r',frame=["phoebe"],context='plotting:selector'),
         #~ dict(qualifier='alpha', description='alpha value of marker',repr='%f',cast_type=float,value=1.,frame=["phoebe"],context='plotting:selector'),
         #~ dict(qualifier='size', description='width of axvspan (percent of plot) or markersize',cast_type=int,value=1,frame=["phoebe"],context='plotting:selector'),
         #~ ]
