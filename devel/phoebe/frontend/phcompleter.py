...
class Completer:
    ...
    def attr_matches(self, text):
        ...
        tb_compl_commands = {'.get_parameter(': {'kind': 'Parameter', 'method': ['match', 'robust']},
                        ...
                        '.get_ps(': {'kind': 'ParameterSet', 'method': ['regex', 'robust']},
                        ...
                        '.get_object(': {'kind': 'Body', 'method': ['regex', 'robust']},
                        '.get_children(': {'kind': 'Body', 'method': ['regex', 'robust']},
                        '.get_parent(': {'kind': 'Body', 'method': ['regex', 'robust']},
                        '.set_enabled(': {'kind': 'OrderedDict', 'section': 'dataset', 'context': 'None', 'method': ['regex', 'robust']},
                        '.enable_data(': {'kind': 'OrderedDict', 'section': 'dataset', 'context': 'None', 'method': ['regex', 'robust']},
                        '.disable_data(': {'kind': 'OrderedDict', 'section': 'dataset', 'context': 'None', 'method': ['regex', 'robust']},
                        '.get_obs(': {'context': '*obs', 'class_name': '*DataSet', 'method': ['regex', 'robust']},
                        '.reload_obs(': {'context': '*obs', 'class_name': '*DataSet', 'method': ['regex', 'robust']},
                        '.plot_obs(': {'context': '*obs', 'class_name': '*DataSet', 'method': ['regex', 'robust']},
                        '.plot_residuals(': {'context': '*obs', 'class_name': '*DataSet', 'method': ['regex', 'robust']},
                        '.get_syn(': {'context': '*syn', 'class_name': '*DataSet', 'method': ['regex', 'robust']},
                        '.plot_syn(': {'context': '*syn', 'class_name': '*DataSet', 'method': ['regex', 'robust']},
                        '.get_dep(': {'context': '*dep', 'kind': 'ParameterSet', 'method': ['regex', 'robust']},
