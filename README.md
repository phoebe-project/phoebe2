...
* Fix handling of spots in single star rotstar case where spots were not co-rotating properly [#1008]
* Fix misalined spots bug that caused size of spot to change across the rotation period
