...
+---------------------------------------------+------------------------------------------------+-----------------------------------------------+
| .. image:: images_tut/KOI126_lc_000.png     | .. image:: images_tut/KOI126_im_000.png        | .. image:: images_tut/KOI126_lc_001.png       |
...
+---------------------------------------------+------------------------------------------------+-----------------------------------------------+
| .. image:: images_tut/KOI126_lc_002.png     | .. image:: images_tut/KOI126_lc_003.png        | .. image:: images_tut/KOI126_lc_004.png       |
|    :scale: 95 %                             |    :scale: 95 %                                |    :scale: 95 %                               |
|    :width: 266px                            |    :width: 266px                               |    :width: 266 px                             |
|    :height: 266px                           |    :height: 266px                              |    :height: 266 px                            |
+---------------------------------------------+------------------------------------------------+-----------------------------------------------+
...
+---------------------------------------------+------------------------------------------------+-----------------------------------------------+
| .. image:: images_tut/KOI126_lc_005.png     | .. image:: images_tut/KOI126_lc_006.png        | .. image:: images_tut/KOI126_lc_007.png       |
|    :scale: 95 %                             |    :scale: 95 %                                |    :scale: 95 %                               |
|    :width: 266px                            |    :width: 266px                               |    :width: 266 px                             |
|    :height: 266px                           |    :height: 266px                              |    :height: 266 px                            |
+---------------------------------------------+------------------------------------------------+-----------------------------------------------+
...
+---------------------------------------------+------------------------------------------------+-----------------------------------------------+
| .. image:: images_tut/KOI126_lc_008.png     | .. image:: images_tut/KOI126_lc_009.png        |                                               |
|    :scale: 95 %                             |    :scale: 95 %                                |                                               |
