...
class Passband:
    ...
    def compute_ck2004_reddening(self, path, Ebv=None, Rv=None, verbose=False):
		...
		self._ck2004_exinct_axes = (np.unique(Teff), np.unique(logg), np.unique(abun), np.unique(Ebv), np.unique(Rv))

		self._ck2004_extinct_energy_grid = np.nan*np.ones((len(self._ck2004_axes[0]), len(self._ck2004_axes[1]), len(self._ck2004_axes[2]), len(self._ck2004_axes[3]), len(self._ck2004_axes[4]), 1))
		self._ck2004_extinct_photon_grid = np.nan*np.ones((len(self._ck2004_axes[0]), len(self._ck2004_axes[1]), len(self._ck2004_axes[2]), len(self._ck2004_axes[3]), len(self._ck2004_axes[4]), 1))
