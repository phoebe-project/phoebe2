...
class SinusoidalThirdLight(DatasetFeature):
    ...
    def get_parameters(self, feature, **kwargs):
        ...
        params += [FloatParameter(qualifier='freq', latexfmt=r'f_\mathrm{{ {feature} }}', value=kwargs.get('freq', 2*np.pi/3.0), default_unit=u.rad/u.d, advanced=True, description='Frequency of the third light sinusoidal contribution')]
