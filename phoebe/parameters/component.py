...
def star(component, **kwargs):
    ...
    * (<phoebe.parameters.ParameterSet>, list): ParameterSet of all newly created
    ...
    params += [FloatParameter(qualifier='loghefrac', visible_if='hierarchy.is_contact_binary:False,atm_in_computes:tmap*', value=kwargs.get('loghefrac', 0.), default_unit=u.dimensionless_unscaled, limits=(0.0,1.0), description='Helium fraction, log(He/H) abundance by number.')]
