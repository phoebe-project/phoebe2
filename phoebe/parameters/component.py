...
def envelope(component, **kwargs):
    ...
    * (<phoebe.parameters.ParameterSet>, list): ParameterSet of all newly created
    ...
    params += [FloatArrayParameter(qualifier='mixing_params', latexfmt=r'\mathrm{{w}}_\mathrm{{ {component} }}', value=kwargs.get('mixing_params', [0.5, 0.5]), default_unit=u.dimensionless_unscaled, description='Parameters of the energy transfer mode of the envelope')]
