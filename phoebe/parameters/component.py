...
def star(component, **kwargs):
    ...
    * (<phoebe.parameters.ParameterSet>, list): ParameterSet of all newly created
    ...
    params += [FloatParameter(qualifier='mass', latexfmt=r'M_\mathrm{{ {component} }}', value=kwargs.get('mass', 1.0), limits=(1e-12, None), default_unit=u.solMass, description='Mass')]
...
def envelope(component, **kwargs):
    ...
    * (<phoebe.parameters.ParameterSet>, list): ParameterSet of all newly created
    ...
    params += [FloatArrayParameter(qualifier='mixing_params', latexfmt=r'\mathrm{{w}}_\mathrm{{ {component} }}', value=kwargs.get('mixing_params', [0.5, 0.5]), default_unit=u.dimensionless_unscaled, limits=(0.0, None), description='Parameters of the energy transfer mode of the envelope')]
    params += [FloatParameter(qualifier='mixing_width', latexfmt=r'\mathrm{{h}}_\mathrm{{ {component} }}', value=kwargs.get('mixing_width', 0.25), default_unit=u.dimensionless_unscaled, limits=(0.0, 1.0), description='Parameters of the width of the energy transfer band in lateral mixing')]
    params += [ChoiceParameter(qualifier='mixing_method', latexfmt=r'\mathrm{{smethod}}_\mathrm{{ {component} }}', value=kwargs.get('mixing_method', 'lateral'), choices=['lateral', 'isotropic', 'internal', 'smoothing'], description='Method for thermal mixing of the envelope')]
