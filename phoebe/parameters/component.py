...
def envelope(component, **kwargs):
    ...
    * (<phoebe.parameters.ParameterSet>, list): ParameterSet of all newly created
    ...
    params += [BoolParameter(qualifier='smoothing_enabled', value=kwargs.get('smoothing_enabled', True), description='Whether to smooth the envelope temperature distribution across the neck')]
