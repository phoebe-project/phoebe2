...
def orbit(component, **kwargs):
    ...
    params += [FloatParameter(qualifier='ecc', timederiv='deccdt', value=kwargs.get('ecc', 0.0), default_unit=u.dimensionless_unscaled, limits=(0.0,1.0-1e-6), description='Eccentricity')]
    if conf.devel:
