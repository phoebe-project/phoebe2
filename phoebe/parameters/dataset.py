...
def lc_dep(is_lc=True, **kwargs):
    ...
    dep_params += [ChoiceParameter(qualifier='intensities_weighted', value=kwargs.get('intensities_weighted', 'energy'), choices=['energy', 'photon'], description='Whether passband intensities are weighted by energy of photons')]
    if is_lc:
