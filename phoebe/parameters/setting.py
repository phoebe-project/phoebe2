...
def settings(**kwargs):
    ...
    params += [SelectParameter(qualifier='run_checks_compute', value=kwargs.get('run_checks_compute', '*'), choices=[''], description='Compute options to use when calling run_checks or within interactive checks.')]
