...
def settings(**kwargs):
    ...
    params += [ChoiceParameter(qualifier='plotting_backend', value=kwargs.get('plotting_backend', 'mpl'), choices=['mpl', 'mpld3', 'mpl2bokeh', 'bokeh'] if _devel_enabled else ['mpl'], description='Default backend to use for plotting')]
