...
def settings(**kwargs):
    ...
    params += [BoolParameter(qualifier='auto_add_figure', value=kwargs.get('auto_add_figure', False), description='Whether to automatically add figure parameters when a dataset is added with a new dataset type.')]
