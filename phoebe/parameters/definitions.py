...
defs += [dict(qualifier='f1',    description="Primary star synchronicity parameter"      ,repr='%f',llim=  0.0, ulim=   10.0,step=   0.01, adjust=False,cast_type=float,value=1.,frame=["wd"],alias=['phoebe_f1'],context='root'), 
         ...
         dict(qualifier='pot1',  description="Primary star surface potential"            ,repr='%f',llim=  0.0, ulim=  200.0,step=   0.01, adjust=False,cast_type=float,value=7.34050,frame=["wd"],alias=['phoebe_pot1'],context='root'),
         dict(qualifier='pot2',  description="Secondary star surface potential"          ,repr='%f',llim=  0.0, ulim=  200.0,step=   0.01, adjust=False,cast_type=float,value=7.58697,frame=["wd"],alias=['phoebe_pot2'],context='root'),
