...
defs += [dict(qualifier='ref',        description='identifier for the plotting options',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         ...
         dict(qualifier='repeat',       description='handy if you are actually fitting a phase curve, and you want to repeat the phase curve a couple of times.',repr='%d',cast_type=int,value=0,frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         dict(qualifier='fmt',          description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='k.',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         dict(qualifier='color',        description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         ...
         dict(qualifier='marker',       description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         ...
         #~ dict(qualifier='markeredgecolor',   description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='markerfacecolor',   description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
         #~ dict(qualifier='linestyle',    description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['plotting:plot_obs','plotting:plot_residuals']),
...
defs += [dict(qualifier='ref',        description='identifier for the plotting options',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_syn'),
         ...
         dict(qualifier='repeat',       description='handy if you are actually fitting a phase curve, and you want to repeat the phase curve a couple of times.',repr='%d',cast_type=int,value=0,frame=["phoebe"],context='plotting:plot_syn'),
         dict(qualifier='fmt',          description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='k.',frame=["phoebe"],context='plotting:plot_syn'),
         dict(qualifier='color',        description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_syn'),
         ...
         dict(qualifier='marker',       description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_syn'),
         ...
         #~ dict(qualifier='markeredgecolor',   description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='markerfacecolor',   description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_syn'),
         #~ dict(qualifier='linestyle',    description='see matplotlib.axes.Axes.plot',repr='%s',cast_type=str,value='',frame=["phoebe"],context='plotting:plot_syn'),
