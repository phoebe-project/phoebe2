...
defs += [dict(qualifier='ld_func', description='Limb darkening model',repr='%s',cast_type='choose',choices=['uniform','linear','logarithmic', 'quadratic', 'square root','claret'],value='uniform',frame=["phoebe"],context=['lcdep','rvdep']),
         ...
         dict(qualifier='user_columns', description='Column names given by user', repr='%s', value=None, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs','ifobs']),
         dict(qualifier='user_components', description='Component names given by user', repr='%s', value=None, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs']),
         dict(qualifier='user_dtypes', description='Data types given by user', repr='%s', value=None, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs']),
         dict(qualifier='user_units', description='Units given by user', repr='%s', value=None, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs']),
        ]
...
defs += [dict(qualifier='method',    description='Nonlinear fitting method',repr='%s',cast_type='choose',value='leastsq',choices=['leastsq','nelder','lbfgsb','anneal','powell','cg','newton','cobyla','slsqp'],frame=["phoebe"],context='fitting:lmfit'),
         dict(qualifier='iters',     description='Number of iterations',long_description='If iters=n, then n number of iterations will be done. With `init_from_prior=True`, you can randomize the starting point for the fit.',repr='%d',cast_type=int,value=0,frame=["phoebe"],context='fitting:lmfit'),
