...
defs += [dict(qualifier='ld_func', description='Limb darkening model',repr='%s',cast_type='choose',choices=['uniform','linear','logarithmic', 'quadratic', 'square root','claret'],value='uniform',frame=["phoebe"],context=['lcdep','rvdep']),
         ...
         dict(qualifier='ref',    description='Name of the data structure',repr='%s',cast_type=str,value='',frame=["phoebe"],context=['lcobs','rvobs','spobs','ifobs','psdep','lcsyn','spsyn','rvsyn','ifsyn','plsyn','plobs']),
         dict(qualifier='time',     description='Timepoints of the data',repr='%s',cast_type=np.array,value=[],unit='JD',frame=['phoebe'],context=['lcobs','spobs','rvobs','ifobs','plobs']),
         ...
         dict(qualifier='user_columns', description='Column names given by user', repr='%s', value=None, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs','ifobs','spobs','plobs']),
         dict(qualifier='user_components', description='Component names given by user', repr='%s', value=None, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs','spobs','plobs']),
         dict(qualifier='user_dtypes', description='Data types given by user', repr='%s', value=None, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs','spobs','plobs']),
         dict(qualifier='user_units', description='Units given by user', repr='%s', value=None, cast_type='return_self', frame=['phoebe'], context=['lcobs','rvobs', 'ifobs','spobs','plobs']),
        ]
...
defs += [dict(qualifier='wavelength',description='Wavelengths of calculated spectrum',repr='%s',value=[],unit='nm',frame=["phoebe"],context='spobs'),
         ...
         dict(qualifier='l3',       description='Third light or intercept constant',repr='%f',cast_type=float,value=0.,adjust=False,frame=["phoebe"],context=['lcobs','spobs','ifobs','plobs','rvobs']),
...
defs += [dict(qualifier='ld_func',   description='Limb darkening model',repr='%s',cast_type=str,value='uniform',frame=["phoebe"],context='ifdep'),
         ...
         dict(qualifier='columns',  description='Data columns',repr='%s',value=['time','ucoord','vcoord','vis2','sigma_vis2','phase','sigma_phase'],cast_type='return_list_of_strings',frame=["phoebe"],context=['ifobs','ifsyn']),
...
defs += [dict(qualifier='location',     description="location in the figure for this axis", repr='%s',cast_type=str,value='auto',frame=["phoebe"],context='plotting:axes'),
         ...
         dict(qualifier='yaxis',        description="quantity to plot on the yaxis", repr='%s',cast_type=str,value='auto',frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='xlabel',        description="label on the xaxis", repr='%s',cast_type=str,value='auto',frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='ylabel',        description="label on the yaxis", repr='%s',cast_type=str,value='auto',frame=["phoebe"],context='plotting:axes'),
         ...
         dict(qualifier='xticks',        description="sequence of floats to draw xticks", repr='%s',cast_type=list,value=['auto'],frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='yticks',        description="list of floats to draw yticks", repr='%s',cast_type=list,value=['auto'],frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='xticklabels',        description="list of strings for labels on xticks", repr='%s',cast_type=list,value=['auto'],frame=["phoebe"],context='plotting:axes'),
         dict(qualifier='yticklabels',        description="list of strings for labels on yticks", repr='%s',cast_type=list,value=['auto'],frame=["phoebe"],context='plotting:axes'),
        ]
...
defs += [dict(qualifier='ra', description='Right ascension', repr='%s', value=0.0, unit='deg', cast_type=float, frame=['phoebe'], context=['global']),
         dict(qualifier='dec', description='Declination', repr='%s', value=0.0, unit='deg', cast_type=float, frame=['phoebe'], context=['global']),
         dict(qualifier='epoch', description='Epoch of coordinates', repr='%s', value=2000.0, cast_type=float, frame=['phoebe'], context=['global']),
