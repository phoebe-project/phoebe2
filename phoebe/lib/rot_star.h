  ...
  */
  ...
  int area_volume(
   ...
   if (t == 1) {
    ...
    //
    if (t < 0.1) {
       if (b_area) // relative precision at least 1e-16 for t < 0.1
        res[0] = fA*(
          1. + t*(0.1975308641975309 + t*(0.08779149519890261 + t*(0.05053817289756933 +
              ...
              t*(0.007978250951469069 + t*(0.006843377097975714 + t*0.005957052715093493)))))))))));


      if (b_vol)  // relative precision at least 1e-16 for t < 0.1
        res[1] = fV*(
