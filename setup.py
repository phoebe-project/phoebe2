...
#
def check_unix_compiler(compiler, extensions, compiler_name):
...
class build_check(build_ext):
  ...
  def build_extensions(self):
    ...
    if plat == 'Windows':
      ...
      if (
          check_unix_compiler(self.compiler, self.extensions, self.compiler.compiler_cxx[0]) and
          check_unix_compiler(self.compiler, self.extensions, self.compiler.compiler_so[0])
         ):
