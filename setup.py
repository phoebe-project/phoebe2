...
setup (name = 'phoebe',
       ...
       packages = ['phoebe', 'phoebe.parameters', 'phoebe.parameters.fitting', 'phoebe.frontend', 'phoebe.constraints', 'phoebe.dynamics', 'phoebe.distortions', 'phoebe.algorithms', 'phoebe.atmospheres', 'phoebe.backend', 'phoebe.fittingbackends', 'phoebe.utils', 'phoebe.dependencies', 'phoebe.dependencies.autofig', 'phoebe.dependencies.nparray', 'phoebe.dependencies.npdists', 'phoebe.dependencies.unitsiau2015'],
