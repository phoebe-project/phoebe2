...
setup (name = 'phoebe',
       ...
       install_requires=['numpy>=1.12','scipy>=1.2','astropy>=1.0', 'corner', 'pytest', 'requests', 'tqdm', 'python-socketio[client]']+['flask>=2.*', 'flask-cors', 'flask-socketio==4.3.*', 'gevent-websocket'],
