...
setup (name = 'phoebe',
       ...
       install_requires=['numpy>=1.15','scipy>=1.4','astropy>=3.0', 'corner', 'pytest', 'requests', 'tqdm', 'python-socketio[client]']+['flask==2.*', 'flask-cors', 'flask-socketio==4.3.*', 'gevent-websocket'],
