...
setup (name = 'phoebe',
       ...
       install_requires=['numpy>=1.22','scipy>=1.2','astropy>=2.0', 'corner', 'pytest', 'requests', 'tqdm', 'python-socketio[client]']+['flask', 'flask-cors', 'flask-socketio==4.3.*', 'gevent-websocket'],
